...
import { FREE_RESOURCE_CATEGORIES, INITIAL_FREE_RESOURCES } from '../../data/freeResourcesData'
      ...
      render: (row) => (
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 text-sm font-medium text-[#c96565]"
          >
  ...
  return (
    <div className="figma-admin-section min-h-screen bg-[#f7f7f7] px-4 pb-8 pt-6 sm:px-5 lg:px-6">
      <section className="mx-auto max-w-screen-2xl space-y-5">
        ...
        />
        <PaginatedFigmaTable columns={columns} data={filtered} emptyMessage="No free resources match your filters." itemLabel="resources" resetDeps={[search, categoryFilter, statusFilter]} />
      </section>
      <AddFreeResourceModal open={modal.isOpen} onClose={modal.close} item={modal.selectedItem} categories={categories} onSubmit={handleSaveResource} />
      <ModifyFreeResourceCategoryModal open={categoryOpen} onClose={() => setCategoryOpen(false)} categories={categories} onAddCategory={handleAddCategory} onDeleteCategory={handleDeleteCategory} />
    </div>
  )
}
