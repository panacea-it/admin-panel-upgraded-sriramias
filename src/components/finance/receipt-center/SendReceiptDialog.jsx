...
import { Download, Mail, MessageCircle, MessageSquare, Printer, Send, X } from 'lucide-react'
      ...
      {open && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-4">
          ...
          <motion.div
            ...
            className="relative flex max-h-[92vh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl bg-white shadow-[0_24px_60px_rgba(15,23,42,0.25)]"
          >
            <div className="flex items-center justify-between border-b border-slate-100 bg-gradient-to-r from-[#f8fbff] to-white px-5 py-4">
              <div>
                      ...
                      {CHANNELS.map(({ id, icon: Icon, color }) => (
                        <button
                          ...
                          className={cn(
                            ...
                            channel === id ? color + ' bg-white shadow-sm' : 'border-slate-200 text-[#686868] hover:border-slate-300',
                          )}
                        >
