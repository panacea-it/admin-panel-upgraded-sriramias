...
export default function StickyFooter({ onResetPermissions, onSave }) {
  return (
    <motion.footer
      ...
      className="fixed bottom-0 left-0 right-0 z-40 border-t border-slate-200/80 bg-white/85 px-4 py-3 shadow-[0_-8px_32px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-slate-700/80 dark:bg-slate-900/90 lg:left-[260px]"
    >
      <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex w-full flex-wrap items-center justify-end gap-2 sm:w-auto">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-slate-200/80 bg-white px-3.5 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
          >
