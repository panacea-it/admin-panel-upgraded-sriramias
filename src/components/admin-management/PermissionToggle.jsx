  ...
  return (
    <button
      ...
      className={cn(
        ...
        allowed
          ? 'bg-emerald-500/15 text-emerald-700 ring-1 ring-emerald-500/30 hover:bg-emerald-500/25 dark:text-emerald-400'
          : 'bg-rose-500/10 text-rose-600 ring-1 ring-rose-500/25 hover:bg-rose-500/20 dark:text-rose-400',
